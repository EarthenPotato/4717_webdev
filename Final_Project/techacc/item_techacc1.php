...
$itemName = mysqli_real_escape_string($conn, "TP1"); // Always escape variables used in SQL queries
...
<head>
    <meta charset="UTF-8">
    <title>Ergonomic Wireless Mouse</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="rightcolumn">
            <div class="content">
            <form action="item_techacc1.php" method="post">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="default_product" value="TQ1">
                    ...
                    <tr>
                        <td>
                            <p>
                            Navigate with precision and comfort using our Ergonomic Wireless Mouse.
                            Its sculpted design promotes a natural hand position, reducing strain during long work sessions.
                            Responsive buttons and a high-precision scroll wheel enhance your productivity.
                            With its plug-and-play wireless connectivity, say goodbye to tangled cords and enjoy a clean, organized workspace.
                            </p>
                        </td>
                    </tr>
                </table>     
