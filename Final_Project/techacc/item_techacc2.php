...
$itemName = mysqli_real_escape_string($conn, "TP2"); // Always escape variables used in SQL queries
...
<body>
    <div id="wrapper">
        ...
        <div id="rightcolumn">
            <div class="content">
            <form action="item_techacc2.php" method="post">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="default_product" value="TQ2">
                    ...
                    <tr>
                        <td>
                            <p>
                            Stay charged on the go with our sleek Portable Power Bank.
                            Its compact, durable design fits easily into any bag, making it the perfect travel companion for your devices.
                            With high-capacity charging and dual USB ports, it powers multiple gadgets simultaneously, ensuring you're always connected when it matters most.
                            </p>
                        </td>
                    </tr>
                </table>     
